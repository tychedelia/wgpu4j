...
import org.wgpu4j.constant.BufferBindingType;
import org.wgpu4j.constant.ShaderStageFlags;
 ...
 */
public class BindGroupLayoutEntry implements Marshalable {
    ...
    public MemorySegment marshal(Arena arena) {
        ...
        switch (bindingType) {
            ...
            case SAMPLER -> {
                ...
                MemorySegment samplerStruct = samplerBindingLayout.marshal(arena);
            ...
            case TEXTURE -> {
                ...
                MemorySegment textureStruct = textureBindingLayout.marshal(arena);
